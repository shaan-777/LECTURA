                ...
                <motion.div
                  ...
                  <div className="flex justify-between w-full items-center gap-4">
                    ...
                    <motion.p
                      ...
                      animate={{ opacity: 1 }}
                      layout
                      className="rounded-lg px-2 py-1 w-fit flex-shrink-0 text-sm text-white bg-zinc-800 shadow-[0_0_10px_rgba(255,255,255,0.1)]">
                      {(file.size / (1024 * 1024)).toFixed(2)} MB
                    </motion.p>
                  </div>

                  <div
                    className="flex text-sm md:flex-row flex-col items-start md:items-center w-full mt-2 justify-between text-gray-300">
                    <motion.p
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      layout
                      className="px-1 py-0.5 rounded-md bg-zinc-800 ">
                      {file.type}
                    </motion.p>
...
export function GridPattern() {
  ...
  return (
    (<div
      className="flex bg-zinc-900 flex-shrink-0 flex-wrap justify-center items-center gap-x-px gap-y-px  scale-105">
          ...
          return (
            (<div
              ...
              className={`w-10 h-10 flex flex-shrink-0 rounded-[2px] ${
                index % 2 === 0
                  ? "bg-black"
                  : "bg-zinc-900 shadow-[0px_0px_1px_3px_rgba(0,0,0,1)_inset]"
              }`} />)
          );
        }))}
    </div>)
